  ...
  render() {
    return (
      <div>
        ...
        <h2>Ted Ahlberg</h2>
        <p>
        Som en del i mitt examensarbete ska jag undersöka användbarheten och utformandet av texter för mobila enheter. För att kunna undersöka detta har jag utformat denna webbapplikation, applikationen möjliggör insamlingen av data för undersökningen. All data som samlas in om deltagaren är helt anonym och kommer inte kunna spåras tillbaka till deltagaren. 
        </p>
        <p>
